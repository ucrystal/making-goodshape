...
public class Personal_menu extends Activity {

	Button profile_btn, schedule_btn;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		profile_btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(Personal_menu.this, Profile.class);
				startActivity(intent);
				overridePendingTransition(R.anim.default_start_enter, R.anim.default_start_exit);
				finish();
			}
		});
		schedule_btn = (Button) findViewById(R.id.btn_schedule);
		schedule_btn.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {


				Intent intent = new Intent(Personal_menu.this, Schedule_calendar.class);
				startActivity(intent);
				overridePendingTransition(R.anim.default_start_enter, R.anim.default_start_exit);
				finish();
			}
